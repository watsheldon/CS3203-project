...
SelectClause QueryObject::getSelect() { return this->select; }

SuchThatClause QueryObject::getSuchThat() { return this->such_that_; }

PatternClause QueryObject::getPattern() { return this->pattern; }

bool QueryObject::isValid() { return isValidQuery; }
bool QueryObject::hasSuchThat() { return hasSuchThatClause; }
bool QueryObject::hasPattern() { return hasPatternClause; }
...
void QueryObject::setSuchThat(SuchThatType type, std::string ref1,
                              std::string ref2) {
    such_that_.setType(type);
    such_that_.setRef1(ref1);
    such_that_.setRef2(ref2);
}
void QueryObject::setPattern(std::string syn, std::string ref1,
                             std::string ref2) {
    pattern.setSynonym(syn);
    pattern.setRef1(ref1);
    pattern.setRef2(ref2);
}
void QueryObject::setIsValid(bool isValid) { isValidQuery = isValid; }
