#ifndef SRC_SPA_SRC_QPS_CONDITIONS_PATTERNIF_H_
#define SRC_SPA_SRC_QPS_CONDITIONS_PATTERNIF_H_
...
namespace spa {
class PatternIfClause : public PatternBase {
  protected:
...
#endif  // SRC_SPA_SRC_QPS_CONDITIONS_PATTERNIF_H_
