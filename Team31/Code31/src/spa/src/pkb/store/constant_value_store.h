#ifndef SRC_SPA_SRC_PKB_STORE_CONSTANT_VALUE_STORE_H_
#define SRC_SPA_SRC_PKB_STORE_CONSTANT_VALUE_STORE_H_
...
#endif  // SRC_SPA_SRC_PKB_STORE_CONSTANT_VALUE_STORE_H_
